  ...
  "components" : {
    ...
    "schemas" : {
      ...
      "CreateUserRequest" : {
        ...
        "required" : [ "userName", "domainName", "password" ]
      },
      "EmptyResponse" : {
        "type" : "object",
        "properties" : { },
      ...
      "GetUserPasswordResetMethod" : {
        ...
        "required" : [ "type", "target", "description", "allowMfaReset" ]
      },
      "GetUserResponse" : {
        "type" : "object",
        "properties" : {
        ...
        "required" : [ "enableSearchIndexing", "recoveryEnabled", "requireTwoFactorAuthentication", "enableSpamFiltering", "resetMethods" ]
      },
      ...
      "CreateRoutingRequest" : {
        ...
        "required" : [ "domainName", "prefix", "matchUser", "targetAddresses" ]
      },
      ...
      "RoutingRule" : {
        ...
        "required" : [ "id", "domainName", "prefix", "matchUser", "targetAddresses", "catchall" ]
      },
      "ListRoutingResponse" : {
        "type" : "object",
        "properties" : {
      ...
      "ApiDomainDnsSummary" : {
        ...
        "required" : [ "passesMx", "passesSpf", "passesDkim", "passesDmarc" ]
      },
      "ApiDomainInfo" : {
        "type" : "object",
        "properties" : {
        ...
        "required" : [ "name", "allowAccountReset", "symbolicSubaddressing", "isShared", "dnsSummary" ]
      },
      "ListDomainsResponse" : {
        "type" : "object",
        "properties" : {
